...
(cond ((assoc 'b '((a 1) (b 2))) => cadr)
      (else false))
In proc EVAL-cond to execute: (cond ((assoc 'b '((a 1) (b 2))) => cadr) (else false))
In proc EVAL-if to execute: (if (not (eq? (assoc 'b '((a 1) (b 2))) false)) (cadr (assoc 'b '((a 1) (b 2)))) false)
Type not found: not
In proc lookup-variable-value to execute: #<procedure:exp>
Type not found: eq?
In proc lookup-variable-value to execute: #<procedure:exp>
Type not found: assoc
In proc lookup-variable-value to execute: #<procedure:exp>
In proc lookup-variable-value to execute: #<procedure:exp>
Type not found: cadr
In proc lookup-variable-value to execute: #<procedure:exp>
...
(cond ((assoc 'a '((a 1) (b 2))) => cadr)
      (else false))
In proc EVAL-cond to execute: (cond ((assoc 'a '((a 1) (b 2))) => cadr) (else false))
In proc EVAL-if to execute: (if (not (eq? (assoc 'a '((a 1) (b 2))) false)) (cadr (assoc 'a '((a 1) (b 2)))) false)
Type not found: not
In proc lookup-variable-value to execute: #<procedure:exp>
Type not found: eq?
In proc lookup-variable-value to execute: #<procedure:exp>
...
(cond ((assoc 'c '((a 1) (b 2))) => cadr)
      (else false))
In proc EVAL-cond to execute: (cond ((assoc 'c '((a 1) (b 2))) => cadr) (else false))
In proc EVAL-if to execute: (if (not (eq? (assoc 'c '((a 1) (b 2))) false)) (cadr (assoc 'c '((a 1) (b 2)))) false)
Type not found: not
In proc lookup-variable-value to execute: #<procedure:exp>
Type not found: eq?
In proc lookup-variable-value to execute: #<procedure:exp>
