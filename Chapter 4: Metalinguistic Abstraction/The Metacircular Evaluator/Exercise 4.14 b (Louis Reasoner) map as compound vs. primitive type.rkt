...
[Metacircular Evaluator Output] >>> map: contract violation
  expected: procedure?
  given: '(primitive #<procedure:abs>)
[Metacircular Evaluator Input] >>>
(define (inc x) (+ x 1))
...
[Metacircular Evaluator Output] >>> map: contract violation
  expected: procedure?
  given: #0=(list 'procedure '(x) '((+ x 1)) (list (mcons '(abs primitive #<procedure:abs>) (mcons '(assoc primitive #<procedure:assoc>) (mcons '(car primitive #<procedure:car>) (mcons '(cadr primitive #<procedure:cadr>) (mcons '(cdr primitive #<procedure:...
[Metacircular Evaluator Input] >>>
.
