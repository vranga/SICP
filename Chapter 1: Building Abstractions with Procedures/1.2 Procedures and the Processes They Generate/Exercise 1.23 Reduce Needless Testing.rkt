...
; rather 2, 3, 5, 7, 9, .... To implement this change, define a procedure next that
; returns 3 if its input is equal to 2 and otherwise returns its input plus 2. Modify the
