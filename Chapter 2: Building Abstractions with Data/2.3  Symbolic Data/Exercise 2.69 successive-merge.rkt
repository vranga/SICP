...
; pairs (where no symbol appears in more than one pair) and generates a Huffman encoding tree
...
; successively merge the smallest-weight elements of the set until there is only one element
