...
; that it signals an error if the symbol is not in the tree at all. Test your procedure
; by encoding the result you obtained in exercise 2.67 with the sample tree and seeing
