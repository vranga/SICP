...
; Exercise 2.91.  A univariate polynomial can be divided by another one to produce a polynomial quotient and
; a polynomial remainder.

; Division can be performed via long division. That is, divide the highest-order term of the dividend by the
; highest-order term of the divisor. The result is the first term of the quotient. Next, multiply the result by
; the divisor, subtract that from the dividend, and produce the rest of the answer by recursively dividing the
; difference by the divisor. Stop when the order of the divisor exceeds the order of the dividend and declare
; the dividend to be the remainder. Also, if the dividend ever becomes zero, return zero as both quotient and
; remainder.

; We can design a div-poly procedure on the model of add-poly and mul-poly. The procedure checks to see if the two
; polys have the same variable. If so, div-poly strips off the variable and passes the problem to div-terms, which
; performs the division operation on term lists. Div-poly finally reattaches the variable to the result supplied by
; div-terms. It is convenient to design div-terms to compute both the quotient and the remainder of a division.
; Div-terms can take two term lists as arguments and return a list of the quotient term list and the remainder term list.

; Complete the following definition of div-terms by filling in the missing expressions. Use this to implement div-poly,
; which takes two polys as arguments and returns a list of the quotient and remainder polys.
...
(define (div-poly p-dividend p-divisor)
	(if (same-variable? (variable p-dividend) (variable p-divisor))
		(let ((result (div-terms (term-list p-dividend) (term-list p-divisor))))
			(list
				(make-poly (variable p-dividend) (car result))
				(make-poly (variable p-dividend) (cadr result))
			)
		)
...
(run-test div p-1-dividend p-1-divisor)
(run-test div p0-dividend p0-divisor)
(run-test div p1-dividend p1-divisor)
(run-test div p2-dividend p2-divisor)
(run-test div p3-dividend p3-divisor)
...
(polynomial x polynomial-sparse-terms ((natural . 0) (natural . 25)) (0 0))
Running (#<procedure:mul> (polynomial x polynomial-sparse-terms (0 5)) (polynomial x polynomial-sparse-terms (1 7) (0 5))) 
(polynomial x polynomial-sparse-terms ((natural . 1) (natural . 35)) ((natural . 0) (natural . 25)) (0 0))
Running (#<procedure:mul> (polynomial x polynomial-sparse-terms (1 7) (0 5)) (polynomial x polynomial-sparse-terms (1 9) (0 -25))) 
(polynomial x polynomial-sparse-terms ((natural . 2) (natural . 63)) ((natural . 1) (integer . -130)) ((natural . 0) (integer . -125)) (0 0))
...
(polynomial x polynomial-sparse-terms ((natural . 6) (natural . 9)) ((natural . 5) (integer . -7)) ((natural . 4) (integer . -50)) ((natural . 3) (natural . 27)) ((natural . 2) (integer . -93)) ((natural . 1) (natural . 5)) ((natural . 0) (natural . 125)) (0 0))
...
(polynomial x polynomial-sparse-terms ((natural . 10) (natural . 2)) ((natural . 9) (natural . 8)) ((natural . 8) (natural . 8)) ((natural . 7) (natural . 11)) ((natural . 6) (natural . 11)) ((natural . 5) (integer . -47)) ((natural . 4) (integer . -35)) ((natural . 3) (integer . -31)) ((natural . 2) (integer . -56)) ((natural . 1) (natural . 65)) ((natural . 0) (natural . 75)) (0 0))
...
(polynomial x polynomial-sparse-terms ((natural . 15) (natural . 6)) ((natural . 14) (natural . 12)) ((natural . 12) (natural . 23)) ((natural . 11) (integer . -5)) ((natural . 10) (integer . -67)) ((natural . 9) (integer . -24)) ((natural . 8) (integer . -28)) ((natural . 7) (integer . -115)) ((natural . 6) (natural . 63)) ((natural . 5) (natural . 107)) ((natural . 4) (integer . -60)) ((natural . 3) (integer . -35)) ((natural . 2) (integer . -26)) ((natural . 1) (natural . 210)) ((natural . 0) (natural . 225)) (0 0))
...
(polynomial x polynomial-sparse-terms ((natural . 22) (natural . 12)) ((natural . 19) (natural . 16)) ((natural . 17) (integer . -44)) ((natural . 16) (natural . 39)) ((natural . 15) (integer . -36)) ((natural . 13) (natural . 24)) ((natural . 12) (integer . -108)) ((natural . 11) (integer . -164)) ((natural . 10) (natural . 87)) ((natural . 8) (integer . -28)) ((natural . 7) (integer . -151)) ((natural . 6) (integer . -34)) ((natural . 5) (natural . 345)) ((natural . 2) (natural . 49)) ((natural . 1) (natural . 210)) ((natural . 0) (natural . 225)) (0 0))
...
(polynomial x polynomial-sparse-terms ((natural . 1) (natural . 15)) ((natural . 0) (natural . 25)) (0 0))
Running (#<procedure:mul> (polynomial x polynomial-dense-terms 1 3 5) (polynomial x polynomial-dense-terms 1 4 9)) 
(polynomial x polynomial-sparse-terms ((natural . 2) (natural . 12)) ((natural . 1) (natural . 47)) ((natural . 0) (natural . 45)) (0 0))
Running (#<procedure:mul> (polynomial x polynomial-dense-terms 1 4 9) (polynomial x polynomial-dense-terms 2 3 5 23)) 
(polynomial x polynomial-sparse-terms ((natural . 3) (natural . 12)) ((natural . 2) (natural . 47)) ((natural . 1) (natural . 137)) ((natural . 0) (natural . 207)) (0 0))
Running (#<procedure:mul> (polynomial x polynomial-dense-terms 2 3 5 23) (polynomial x polynomial-dense-terms 2 4 9 19)) 
(polynomial x polynomial-sparse-terms ((natural . 4) (natural . 12)) ((natural . 3) (natural . 47)) ((natural . 2) (natural . 194)) ((natural . 1) (natural . 302)) ((natural . 0) (natural . 437)) (0 0))
Running (#<procedure:mul> (polynomial x polynomial-dense-terms 2 4 9 19) (polynomial x polynomial-dense-terms 5 1 2 0 3 -2 -5)) 
(polynomial x polynomial-sparse-terms ((natural . 7) (natural . 4)) ((natural . 6) (natural . 17)) ((natural . 5) (natural . 37)) ((natural . 4) (natural . 50)) ((natural . 3) (natural . 19)) ((natural . 2) (natural . 19)) ((natural . 1) (integer . -83)) ((natural . 0) (integer . -95)) (0 0))
...
(polynomial x polynomial-sparse-terms ((natural . 2) (natural . 28)) ((natural . 1) (natural . 83)) ((natural . 0) (natural . 45)) (0 0))
Running (#<procedure:mul> (polynomial x polynomial-sparse-terms (1 9) (0 -25)) (polynomial x polynomial-dense-terms 2 3 5 23)) 
(polynomial x polynomial-sparse-terms ((natural . 3) (natural . 27)) ((natural . 2) (integer . -30)) ((natural . 1) (natural . 82)) ((natural . 0) (integer . -575)) (0 0))
...
(polynomial x polynomial-sparse-terms ((natural . 2) (natural . 27)) ((natural . 1) (integer . -30)) ((natural . 0) (integer . -125)) (0 0))
Running (#<procedure:mul> (polynomial x polynomial-dense-terms 1 4 9) (polynomial x polynomial-sparse-terms (5 1) (4 2) (2 3) (1 -2) (0 -5))) 
(polynomial x polynomial-sparse-terms ((natural . 6) (natural . 4)) ((natural . 5) (natural . 17)) ((natural . 4) (natural . 18)) ((natural . 3) (natural . 12)) ((natural . 2) (natural . 19)) ((natural . 1) (integer . -38)) ((natural . 0) (integer . -45)) (0 0))
...
(polynomial x polynomial-sparse-terms ((natural . 7) (natural . 6)) ((natural . 6) (natural . 22)) ((natural . 5) (natural . 66)) ((natural . 4) (natural . 107)) ((natural . 3) (natural . 4)) ((natural . 2) (natural . 35)) ((natural . 1) (integer . -236)) ((natural . 0) (integer . -345)) (0 0))
...
(polynomial x polynomial-sparse-terms ((natural . 12) (natural . 12)) ((natural . 11) (natural . 27)) ((natural . 10) (natural . 57)) ((natural . 9) (natural . 16)) ((natural . 8) (natural . 36)) ((natural . 7) (natural . 32)) ((natural . 6) (integer . -99)) ((natural . 5) (integer . -209)) ((natural . 3) (integer . -28)) ((natural . 2) (integer . -123)) ((natural . 1) (integer . -268)) ((natural . 0) (integer . -285)) (0 0))
...
(polynomial x polynomial-sparse-terms ((natural . 17) (natural . 4)) ((natural . 16) (natural . 8)) ((natural . 14) (natural . 12)) ((natural . 13) (integer . -8)) ((natural . 12) (integer . -20)) ((natural . 11) (natural . 13)) ((natural . 10) (natural . 14)) ((natural . 9) (integer . -24)) ((natural . 8) (natural . 39)) ((natural . 7) (integer . -62)) ((natural . 6) (integer . -48)) ((natural . 5) (natural . 31)) ((natural . 4) (integer . -30)) ((natural . 3) (integer . -21)) ((natural . 2) (integer . -31)) ((natural . 1) (natural . 65)) ((natural . 0) (natural . 75)) (0 0))
...
(polynomial x polynomial-sparse-terms (0 (integer . -5)))
Running (#<procedure:NEGATE> (polynomial x polynomial-sparse-terms (0 5))) 
(polynomial x polynomial-sparse-terms (0 (integer . -5)))
Running (#<procedure:NEGATE> (polynomial x polynomial-sparse-terms (1 7) (0 5))) 
(polynomial x polynomial-sparse-terms (1 (integer . -7)) (0 (integer . -5)))
Running (#<procedure:NEGATE> (polynomial x polynomial-sparse-terms (1 9) (0 -25))) 
(polynomial x polynomial-sparse-terms (1 (integer . -9)) (0 (natural . 25)))
Running (#<procedure:NEGATE> (polynomial x polynomial-sparse-terms (5 1) (4 2) (2 3) (1 -2) (0 -5))) 
(polynomial x polynomial-sparse-terms (5 (integer . -1)) (4 (integer . -2)) (2 (integer . -3)) (1 (natural . 2)) (0 (natural . 5)))
Running (#<procedure:NEGATE> (polynomial x polynomial-sparse-terms (5 2) (4 4) (2 5) (1 -7) (0 -15))) 
(polynomial x polynomial-sparse-terms (5 (integer . -2)) (4 (integer . -4)) (2 (integer . -5)) (1 (natural . 7)) (0 (natural . 15)))
Running (#<procedure:NEGATE> (polynomial x polynomial-sparse-terms (10 3) (7 4) (5 -11) (1 -7) (0 -15))) 
(polynomial x polynomial-sparse-terms (10 (integer . -3)) (7 (integer . -4)) (5 (natural . 11)) (1 (natural . 7)) (0 (natural . 15)))
Running (#<procedure:NEGATE> (polynomial x polynomial-sparse-terms (12 4) (6 13) (5 -12) (1 -7) (0 -15))) 
(polynomial x polynomial-sparse-terms (12 (integer . -4)) (6 (integer . -13)) (5 (natural . 12)) (1 (natural . 7)) (0 (natural . 15)))
...
(polynomial x polynomial-dense-terms 0 (integer . -5))
Running (#<procedure:NEGATE> (polynomial x polynomial-dense-terms 0 5)) 
(polynomial x polynomial-dense-terms 0 (integer . -5))
Running (#<procedure:NEGATE> (polynomial x polynomial-dense-terms 1 3 5)) 
(polynomial x polynomial-dense-terms 1 (integer . -3) (integer . -5))
Running (#<procedure:NEGATE> (polynomial x polynomial-dense-terms 1 4 9)) 
(polynomial x polynomial-dense-terms 1 (integer . -4) (integer . -9))
Running (#<procedure:NEGATE> (polynomial x polynomial-dense-terms 2 3 5 23)) 
(polynomial x polynomial-dense-terms 2 (integer . -3) (integer . -5) (integer . -23))
Running (#<procedure:NEGATE> (polynomial x polynomial-dense-terms 2 4 9 19)) 
(polynomial x polynomial-dense-terms 2 (integer . -4) (integer . -9) (integer . -19))
Running (#<procedure:NEGATE> (polynomial x polynomial-dense-terms 5 1 2 0 3 -2 -5)) 
(polynomial x polynomial-dense-terms 5 (integer . -1) (integer . -2) 0 (integer . -3) (natural . 2) (natural . 5))
Running (#<procedure:NEGATE> (polynomial x polynomial-dense-terms 5 2 4 0 5 -7 -15)) 
(polynomial x polynomial-dense-terms 5 (integer . -2) (integer . -4) 0 (integer . -5) (natural . 7) (natural . 15))
...
(polynomial x polynomial-sparse-terms (1 (integer . -7)))
...
(polynomial x polynomial-sparse-terms (5 (integer . -1)) (4 (integer . -2)) (2 (integer . -3)) (1 (natural . 11)) (0 (integer . -20)))
...
(polynomial x polynomial-sparse-terms (10 (integer . -3)) (7 (integer . -4)) (5 (natural . 13)) (4 4) (2 5))
...
(polynomial x polynomial-sparse-terms (12 (integer . -4)) (10 3) (7 4) (6 (integer . -13)) (5 (natural . 1)))
...
(polynomial x polynomial-dense-terms 1 (integer . -3) 0)
...
(polynomial x polynomial-dense-terms 2 (integer . -3) (integer . -1) (integer . -14))
...
(polynomial x polynomial-dense-terms 5 (integer . -1) (integer . -2) 0 (natural . 1) (natural . 11) (natural . 24))
...
(polynomial x polynomial-dense-terms 2 (integer . -3) (natural . 4) (integer . -48))
...
(polynomial x polynomial-dense-terms 10 3 0 0 4 0 (integer . -13) (integer . -4) 0 (integer . -5) 0 0)
...
(polynomial x polynomial-sparse-terms (5 (integer . -1)) (4 (integer . -2)) (2 (integer . -3)) (1 (natural . 6)) (0 (natural . 14)))
...
(polynomial x polynomial-sparse-terms (5 (integer . -2)) (4 (integer . -4)) (2 (integer . -2)) (1 (natural . 12)) (0 (natural . 38)))
...
(polynomial x polynomial-sparse-terms (10 (integer . -3)) (7 (integer . -4)) (5 (natural . 11)) (2 4) (1 (natural . 16)) (0 (natural . 34)))
...
(polynomial x polynomial-sparse-terms (12 (integer . -4)) (6 (integer . -13)) (5 (natural . 13)) (4 2) (2 3) (1 (natural . 5)) (0 (natural . 10)))
...
Running (#<procedure:div> (polynomial x polynomial-sparse-terms (1 1)) (polynomial x polynomial-sparse-terms (1 1))) 
(polynomial-list (x polynomial-sparse-terms ((natural . 0) (natural . 1))) (x))
Running (#<procedure:div> (polynomial x polynomial-sparse-terms (6 1)) (polynomial x polynomial-sparse-terms (4 1))) 
(polynomial-list (x polynomial-sparse-terms ((natural . 2) (natural . 1))) (x))
Running (#<procedure:div> (polynomial x polynomial-sparse-terms (5 1) (0 -1)) (polynomial x polynomial-sparse-terms (4 1) (0 -1))) 
(polynomial-list (x polynomial-sparse-terms ((natural . 1) (natural . 1))) (x polynomial-sparse-terms ((natural . 1) (natural . 1)) (0 -1)))
Running (#<procedure:div> (polynomial x polynomial-sparse-terms (5 1) (0 -1)) (polynomial x polynomial-sparse-terms (2 1) (0 -1))) 
(polynomial-list (x polynomial-sparse-terms ((natural . 3) (natural . 1)) ((natural . 1) (natural . 1))) (x polynomial-sparse-terms ((natural . 1) (natural . 1)) (0 -1)))
Running (#<procedure:div> (polynomial x polynomial-sparse-terms (5 6) (4 9) (3 8) (2 -15) (1 -16) (0 5)) (polynomial x polynomial-sparse-terms (2 2) (1 3) (0 4))) 
(polynomial-list (x polynomial-sparse-terms ((natural . 3) (natural . 3)) ((natural . 1) (integer . -2)) ((natural . 0) (real . -4.5))) (x polynomial-sparse-terms (1 (real . 5.5)) (0 (natural . 23)) (0 0)))
> 
