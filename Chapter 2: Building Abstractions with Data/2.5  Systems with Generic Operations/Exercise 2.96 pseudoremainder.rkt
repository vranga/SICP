...
; remainder-terms except that it multiplies the dividend by the integerizing factor described
; above before calling div-terms. Modify gcd-terms to use pseudoremainder-terms, and verify that
; greatest-common-divisor now produces an answer with integer coefficients on the example in
; exercise 2.95.
