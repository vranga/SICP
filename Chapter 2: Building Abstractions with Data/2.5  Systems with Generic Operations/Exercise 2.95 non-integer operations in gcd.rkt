...
; and use greatest-common-divisor (exercise 2.94) to compute the GCD of Q1 and Q2.
; Note that the answer is not the same as P1. This example introduces noninteger operations
; into the computation, causing difficulties with the GCD algorithm. To understand what
; is happening, try tracing gcd-terms while computing the GCD or try performing the division by hand.
...
(define (gcd-terms a b)
	...
	(print (make-polynomial 'x a))
	(display " and ")
	(print (make-polynomial 'x b))
	(newline)
	(if (empty-termlist? b)
		a
...
Computing gcd of: {13x^3 - 21x^2 + 3x + 5} and {8.627218934911244x^2 - 17.254437869822485x + 8.627218934911243}

Computing gcd of: {8.627218934911244x^2 - 17.254437869822485x + 8.627218934911243} and { - 1.2434497875801753e-14x + 7.993605777301127e-15}

Computing gcd of: { - 1.2434497875801753e-14x + 7.993605777301127e-15} and {1.100410578432558}

Computing gcd of: {1.100410578432558} and {}
Result: (polynomial x polynomial-sparse-terms (0 (real . 1.100410578432558)) (0 0))
{1.100410578432558}
