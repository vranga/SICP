...
; variable.) Install in the system a generic operation greatest-common-divisor that reduces
; to gcd-poly for polynomials and to ordinary gcd for ordinary numbers. As a test, try
...
(define p1 (make-polynomial 'x (make-polynomial-sparse-terms (list (list 4 1) (list 3 -1) (list 2 -2) (list 1 2)))))
(define p2 (make-polynomial 'x (make-polynomial-sparse-terms (list (list 3 1) (list 1 -1)))))

(run-test greatest-common-divisor p1 p2)
...
Result: (polynomial x polynomial-sparse-terms (2 (integer . -1)) (1 1) (0 0))
{ - x^2 + x}

> 

; I verified by hand that the correct answer is -x^2 + x (same as what the program produced)
