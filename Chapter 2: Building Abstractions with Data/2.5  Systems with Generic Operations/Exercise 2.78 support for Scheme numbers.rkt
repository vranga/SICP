...
; nothing more than calls to the primitive procedures +, -, etc. It was not possible to
; use the primitives of the language directly because our type-tag system requires that
; each data object have a type attached to it. In fact, however, all Lisp implementations
; do have a type system, which they use internally. Primitive predicates such as symbol?
; and number? determine whether data objects have particular types. Modify the
; definitions of type-tag, contents, and attach-tag from section 2.4.2 so that our
; generic system takes advantage of Scheme's internal type system. That is to say, the
; system should work as before except that ordinary numbers should be represented simply
; as Scheme numbers rather than as pairs whose car is the symbol scheme-number.
...
Searching op-table for make, scheme-number
7
...
Searching op-table for make-from-mag-ang, complex
Searching op-table for make-from-mag-ang, polar
...
Searching op-table for imag-part, (rectangular)
...
Searching op-table for sub, (complex complex)
Entered apply-generic with real-part, ((rectangular 3 . 4))
Searching op-table for real-part, (rectangular)
Entered real-part-rectangular
Entered apply-generic with real-part, ((rectangular 5 . 6))
...
Searching op-table for mul, (complex complex)
...
Searching op-table for angle, (rectangular)
Entered imag-part-rectangular
Entered real-part-rectangular
...
Searching op-table for magnitude, (polar)
Entered proc magnitude
...
Searching op-table for angle, (polar)
...
; Tests on scheme numbers

> (add 8 9)
Entered apply-generic with add, (8 9)
Searching op-table for add, (scheme-number scheme-number)
17
> (make-scheme-number 45)
Searching op-table for make, scheme-number
45
> (sub -54 34)
Entered apply-generic with sub, (-54 34)
Searching op-table for sub, (scheme-number scheme-number)
-88
> (mul -32 3)
Entered apply-generic with mul, (-32 3)
Searching op-table for mul, (scheme-number scheme-number)
-96
> (div -34 17)
Entered apply-generic with div, (-34 17)
Searching op-table for div, (scheme-number scheme-number)
-2
> (make-scheme-number -439)
Searching op-table for make, scheme-number
-439
> (div 35 3)
Entered apply-generic with div, (35 3)
Searching op-table for div, (scheme-number scheme-number)
11 2/3
> 
