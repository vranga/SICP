...
; magnitudes, and angles can be either ordinary numbers, rational numbers, or other numbers we
; might wish to add to the system. Describe and implement the changes to the system needed to
; accommodate this. You will have to define operations such as sine and cosine that are generic
