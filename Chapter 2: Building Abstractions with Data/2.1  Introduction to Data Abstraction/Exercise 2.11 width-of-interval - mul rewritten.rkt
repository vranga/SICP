...
; endpoints of the intervals, it is possible to break mul-interval into nine cases, only one of
...
; such as 3.5± 0.15 rather than [3.35, 3.65]. Alyssa returns to her desk and fixes this
