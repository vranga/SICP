...
> (display-stream-elements 20 ln2-stream)
...
0.6687714031754279
'done
> (display-stream-elements 20 (euler-transform ln2-stream))
...
0.6931346368409872
'done
> (display-stream-elements 10 (accelerated-sequence euler-transform ln2-stream))
